...
class _LastResultLose(_LastResultGameShape):
    ...
    @property
    def get_home_team_playing_home_lose(self):
        return self._home_team['lose']
    ...
    @property
    def get_home_team_playing_away_lose(self):
        return self._home_team['away']['lose']
    ...
    @property
    def get_away_team_playing_home_lose(self):
        return self._away_team['home']['lose']
    ...
    @property
    def get_away_team_playing_away_lose(self):
        return self._away_team['lose']
